 ...
 * @author sumit
 */
public class AppointmentTimeChange extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
          ...
          PreparedStatement pm=cn.prepareStatement("update appointment set response_time=null  where  DateANDTime=? and patient_id= ? and  Doctor_id=?");
